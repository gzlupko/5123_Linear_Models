...
# 4. Assignment
#######
# Run the two-way ANOVA, as above, being sure to check assumptions
# and consider a log transformation if needed, for the condition and
# college factors. Calculate partial eta^2 effect sizes (see p. 330 MDK).
